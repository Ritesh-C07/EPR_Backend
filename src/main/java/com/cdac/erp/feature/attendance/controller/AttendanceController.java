...
public class AttendanceController {
    ...
    public ResponseEntity<Page<AttendanceResponse>> getAttendanceForSession(@PathVariable Integer timetableEntryId, Pageable pageable) {
    ...
    public ResponseEntity<Page<AttendanceResponse>> getAttendanceForSessionAndDate(
        ...
        Page<AttendanceResponse> attendancePage = attendanceService.getAttendanceForSessionAndDate(timetableEntryId, date, pageable);
        return ResponseEntity.ok(attendancePage);
    }
    
    @PutMapping("/{attendanceId}")
    public ResponseEntity<AttendanceResponse> updateAttendance(@PathVariable Integer attendanceId, @Valid @RequestBody AttendanceUpdateRequest request) {
